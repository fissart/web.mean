...
iduser: string = "";
    ...
    type: string = ""
    name: string = ""
  markdown=`Este es un modelo de como puede escribir (formato html) en esta área borre todo y escriba<h1 class='bg-info text-success border p-1 rounded'>Titulo</h1>
