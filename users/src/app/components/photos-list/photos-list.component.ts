...
import SwiperCore, { EffectCoverflow, Virtual, SwiperOptions , Swiper, Navigation, Pagination, Scrollbar, A11y, Autoplay } from 'swiper';

SwiperCore.use([EffectCoverflow, Virtual, Navigation, Pagination, Scrollbar, A11y, Autoplay]);
...
//@ViewChild(ThemesComponent,{static:true}) www: ThemesComponent
